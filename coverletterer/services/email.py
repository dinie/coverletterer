...
def _build_message(to_email: str, link: str) -> EmailMessage:
    msg = EmailMessage()
    msg["Subject"] = "Your CoverLetterer sign-in link"
    msg["From"] = config.smtp_from()
    msg["To"] = to_email
    ttl = config.MAGIC_LINK_TTL_MINUTES
    msg.set_content(
        f"Click the link below to sign in to CoverLetterer:\n\n{link}\n\n"
...
<html><body style="font-family:sans-serif">
  <p>Click the button below to sign in to <strong>CoverLetterer</strong>:</p>
  <p><a href="{link}"
